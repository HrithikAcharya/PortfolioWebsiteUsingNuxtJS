<template>
    <footer id="contact-info">
      <p class="text-center text-balance mb-2">You can get in touch with me through</p>
      <a href = "mailto:hrithikacharya2001@gmail.com"  type="button" data-twe-ripple-init data-twe-ripple-color="light" class="mb-2 inline-block rounded px-4 py-1 text-xs font-medium uppercase leading-normal text-white transition duration-150 ease-in-out scale-125 hover:scale-150 focus:shadow-lg focus:outline-none focus:ring-0">
        ...
        <a href="https://www.linkedin.com/in/hrithik-acharya-208660149/" target="_blank" type="button" data-twe-ripple-init data-twe-ripple-color="light" class="mb-2 inline-block rounded px-4 py-1 text-xs font-medium uppercase leading-normal text-white transition duration-150 ease-in-out scale-125 hover:scale-150 focus:shadow-lg focus:outline-none focus:ring-0">
            <span class="[&>svg]:h-4 [&>svg]:w-4">
      ...
      <p>&copy;2024 Hrithik Acharya. All rights reserved.</p>
    </footer>
  </template>
